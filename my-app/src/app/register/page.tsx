  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (profileError) {
        ...
        setError('Rejestracja auth się powiodła, ale nie udało się utworzyć profilu. Skontaktuj się z support.');
        setLoading(false);
        return;
      }
      
      alert('Zarejestrowano! Sprawdź e-mail aby potwierdzić. Później możesz się zalogować.');
      setEmail('');
      setUsername('');
      setPassword('');
